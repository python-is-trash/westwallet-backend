  ...
  try {
    ...
    if (!user) {
      ...
      if (referrerId) {
        ...
        await ctx.reply(`✅ You've been referred! Your referrer will earn commissions from your investments.`);
      }

      console.log(`✅ New user registered: ${userId} (${username || 'no username'})`);
    }
